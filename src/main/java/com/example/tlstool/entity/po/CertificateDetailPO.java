...
public class CertificateDetailPO {
     ...
     * 公钥加密算法安全性评估
     */
    @TableField(value = "public_key_remark")
    private String publicKeyRemark;

    /**
     * 签名算法安全性评估
     */
    @TableField(value = "signature_hash_algorithm_remark")
    private String signatureHashAlgorithmRemark;
